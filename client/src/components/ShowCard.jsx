function ShowCard({ places, setText,text }) {
    const copyToClipboard = (text) => {   //อันนี้สำหรับที่คัดลอกลิงก์ ด้านหลังรูปเพิ่มเติม
        navigator.clipboard
          .writeText(text)
          .then(() => {
                ...
                <div 
                    ...
                    <div className="w-2/3 flex flex-col gap-2 px-4">
                        ...
                        <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-blue-500 text-sm text-start hover:underline">อ่านต่อ</a>
                        <div className="flex flex-wrap gap-2 text-xs text-blue-600">
                            {place.tags.map((tag, i) => (
                                <button 
                                    ...
                                    setText((prev) => (prev.trim() === "" ? tag : prev + " " + tag));
                                        }
                                    }}
