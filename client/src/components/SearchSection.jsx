function SearchSection({text, setText}) {
    return (
        <div className="search-section flex flex-col items-center justify-center w-full h-1/6 bg-white p-4 rounded-lg shadow-md mb-4 bg-white"> 
            ...
            <h2 className="text-start">ค้นหาที่เที่ยว</h2>
                <input 
                type="text" 
